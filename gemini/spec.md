...
#### 未來可擴充指令建議
*   **/version <專案ID>**
    *   **功能**: 快速查詢指定專案的**最新版本號**以及**最近一次的更新內容**。
    *   **權限**: `@Developer`
*   **/release-notes <專案ID> <版本號>**
    *   **功能**: 自動生成指定版本的**發布說明 (Release Notes)**。
    *   **權限**: `@Developer`, `@PM`
*   **/assign-bug <TicketID> <使用者>**
    *   **功能**: 將一個 BUG 指派給特定的開發者。
    *   **權限**: `@PM`
*   **/update-bug-status <TicketID> <狀態>**
    *   **功能**: 快速更新 BUG 的狀態 (例如：`處理中`, `待測試`, `已解決`)。
    *   **權限**: `@Developer`, `@PM`
*   **/my-tasks**
    *   **功能**: 列出**所有指派給自己**的、狀態為「Open」或「Pending」的 BUG 單。
    *   **權限**: `@Developer`
*   **/whois <專案名稱>**
    *   **功能**: 查詢某個專案的**主要負責人 (PM)** 和**核心開發者**是誰。
    *   **權限**: 全員
*   **/remind-me <時間> <訊息>**
    *   **功能**: 設定一個個人提醒。
    *   **權限**: 全員
